...
struct SkipList {
    ...
    struct SkipListElement {
        ...
        inline bool CASleft(size_t level,
               ...
               return gbbs::atomic_compare_and_swap(&elements[level].first, old_left, new_left);
        }

        inline bool CASright(size_t level,
                SkipListElement* old_right, SkipListElement* new_right) {
               return gbbs::atomic_compare_and_swap(&elements[level].second, old_right, new_right);
        }
